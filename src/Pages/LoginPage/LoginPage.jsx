        ...
        <div>
                ...
                >
                  ...
                  <div className={css.password_flex}>
                    <Input
                      ...
                      onChange={handleChange}
                    />
                    <span className={css.wrapper} onClick={togglePasswordType}>
                      {type === 'password' ? (
                        <svg
                ...
                >
                  ...
                  <div className={css.password_flex}>
                    <Input
                      ...
                      onChange={handleChange}
                    />
                    <span onClick={togglePasswordType} className={css.wrapper}>
                      {type === 'password' ? (
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
          ...
          <div>
            ...
            <div className={css.signSocialMediaFlex}>
              <div className={css.googleFacebook}>
                <img src={imgGoogle} alt="img" />
              </div>
              <div className={css.googleFacebook}>
                <img src={imgFacebook} alt="img" />
              </div>
            </div>
          </div>
        </div>
