...
const Reviews = () => {
    ...
    const reviewsCardProducts = [
        {
            text: '“This is not the first time I shop at this online store and I can confidently recommend it to everyone. The goods arrive on time and securely packaged. \n' +
    ...
    return (
        <section className={css.section}>
            <div className={css.title}>
                <div className={css.title_flex}>{title}</div>
            </div>
                                        ...
                                        <div className={css.review_item}>
                                            <div className={css.review_item_content}>
                                                ...
                                                <div className={css.img_name}>
                                                    <div className={css.review_img}><img src={rev.img}/></div>
